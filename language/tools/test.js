...
eq(O.ajamiPhrase('Es·salām!'), 'السَّلام!', 'the sacred article wears ال — assimilation as shadda (R-059)');
eq(O.ajamiPhrase('al·mēr harāy'), 'المێر هَراي', 'unassimilated article wears ال');
eq(O.ajamiPhrase('en·salāmi'), 'ئێنسَلامِ', 'preposition en· stays phonetic — never article-dressed');
